...
function AddPlayer(){
   ...
   scoreBox.addEventListener("click",(this)=>UpdatePoint(this,1));
   ...
   addPointButton.addEventListener("click",(this)=>UpdatePoint(this,1));
   ...
   removePointBtn.addEventListener("dblclick",(this)=>UpdatePoint(this,-1));
